...
#define R_RX_PL_WID 0x60 // 0b0110 0000 => This command can be used without enabling dynamic payload widths in the FEATURE register, in that case it should return the configured payload width, else an error has occured somewhere.
